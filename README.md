## About
This repository will be used as the base for all projects within the Create More project and maybe as the main page 
for all the subproject repositories. 
