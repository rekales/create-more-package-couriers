...
public enum PortableStockTickerPackets {
    // Client to Server
    ...
    public static final ResourceLocation CHANNEL_NAME = resLoc("main");
    public static final int NETWORK_VERSION = 3;
    public static final String NETWORK_VERSION_STR = String.valueOf(NETWORK_VERSION);
    private static SimpleChannel channel;

    private final PortableStockTickerPackets.PacketType<?> packetType;

    <T extends SimplePacketBase> PortableStockTickerPackets(Class<T> type, Function<FriendlyByteBuf, T> factory,
                                                            NetworkDirection direction) {
        packetType = new PortableStockTickerPackets.PacketType<>(type, factory, direction);
    }
    ...
    public static void register() {
        ...
        for (PortableStockTickerPackets packet : values())
