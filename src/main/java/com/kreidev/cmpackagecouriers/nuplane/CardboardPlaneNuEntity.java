...
public class CardboardPlaneNuEntity extends Entity {
    ...
    public CardboardPlaneNuEntity(EntityType<? extends Entity> entityType, Level level) {
        super(entityType, level);
    }

    public CardboardPlaneNuEntity(Level level, CardboardPlane plane) {
        super(PackageCouriers.CARDBOARD_PLANE_NU_ENTITY.get(), level);
        this.plane = plane;
    ...
    public static CardboardPlaneNuEntity createEmpty(EntityType<? extends CardboardPlaneNuEntity> entityType, Level level) {
        return new CardboardPlaneNuEntity(entityType, level);
    }
}
